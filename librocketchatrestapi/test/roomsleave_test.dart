...
void main() {
  group('Rooms Leave', () {
    test('check default values', () {
      librocketchatrestapi.RoomsLeaveInfo info = librocketchatrestapi.RoomsLeaveInfo("foo");
      expect(info.canStart(), true);

      librocketchatrestapi.RoomsLeave roomsMute = librocketchatrestapi.RoomsLeave(info);
      ...
      expect(
          roomsMute.url("http://www.kde.org"), Uri.parse('http://www.kde.org/api/v1/rooms.leave'));
