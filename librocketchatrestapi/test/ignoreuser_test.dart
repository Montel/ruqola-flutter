...
void main() {
  group('ignore user', () {
    test('check default values', () {
      ...
      librocketchatrestapi.IgnoreUser unfollow = librocketchatrestapi.IgnoreUser(info);
      ...
      expect(unfollow.url("http://www.kde.org"),
          Uri.parse('http://www.kde.org/api/v1/chat.ignoreUser?rid=bla&userId=foo&ignore=true'));
    });
    ...
    test('check can start', () {
      ...
      librocketchatrestapi.IgnoreUser ignoreuser = librocketchatrestapi.IgnoreUser(info);
