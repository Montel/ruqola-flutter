...
class RemoveUserFromRoleInfo {
  final String username;
  final String roleName;
  RemoveUserFromRoleInfo(this.username, this.roleName);
  bool canStart() {
...
class RemoveUserFromRole extends Restapiabstractjob {
  final RemoveUserFromRoleInfo _info;

  RemoveUserFromRole(this._info);

  @override
  bool canStart() {
    if (!super.canStart()) {
      print("Impossible to start RemoveUserFromRole");
      return false;
    }
  ...
  @override
  Uri url(String url) {
    return generateUrl(url, RestApiUrlType.rolesRemoveUserFromRole);
  }
